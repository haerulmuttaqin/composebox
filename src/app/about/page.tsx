                    ...
                    <div className="prose prose-lg mx-auto prose-invert">
                        ...
                        <div className="space-y-6 mb-12">
                            <div className="flex items-start space-x-4">
                                <div
                                    className="w-8 h-8 bg-blue-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-300">See your Compose code results directly without manual
                                        build</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-4">
                                <div
                                    className="w-8 h-8 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-300">Start coding immediately without installing Kotlin,
                            ...
                            <div className="flex items-start space-x-4">
                                <div
                                    className="w-8 h-8 bg-purple-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                            ...
                            <div className="flex items-start space-x-4">
                                <div
                                    className="w-8 h-8 bg-orange-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
