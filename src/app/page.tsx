                ...
                <section className="py-20 bg-zinc-800">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            ...
                            <div className="text-center p-2 bg-zinc-800 rounded-lg border-1 border-zinc-700">
                                <div
                                    className="relative"
                                >
                                    <span
                                        className="absolute -top- right-0 bg-blue-500 text-white text-xs font-semibold px-2.5 py-0.5 rounded-full"
                                    >Coming Soon</span>
                                    <br/>
                                    <div
                                        className="w-16 h-16 bg-purple-500/20 rounded-full flex items-center justify-center
                                    mx-auto mb-4">
